...
use Piwik\Plugins\Bandwidth\Columns\Bandwidth;
use Piwik\View;
 ...
 */
class GetBandwidth extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('Bandwidth_Bandwidth');
        $this->dimension     = new Bandwidth();
        $this->documentation = Piwik::translate('Monitor Bandwidth for each page, download, and measure overall traffic in bytes');
        ...
        // $this->menuTitle    = 'Bandwidth_Bandwidth';
        ...
        // $this->widgetTitle  = 'Bandwidth_Bandwidth';
    }
    ...
    {
        $view = new View('@Bandwidth/getBandwidth');
        $view->myData = array();
